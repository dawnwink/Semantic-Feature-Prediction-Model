...
train_project = 'Birt raw'
project_list = ['tomcat raw','swt raw','AspectJ','JDT','Eclipse UI']
precise = []
for pro in project_list:
    movie_reviews = load_files(r'D:\effort-awareness\Tomcat project\3sub\tf_idf\%s\endata'%train_project) 
    target = []
    data = [] 
    ...
    print pro, precise
    r1 = open(r'D:\effort-awareness\Tomcat project\3sub\tf_idf\%s_tage.txt'%pro, 'w')
    r2 = open(r'D:\effort-awareness\Tomcat project\3sub\tf_idf\%s_y_test.txt'%pro, 'w')
    for i in range(len(tage)):
